export const ConfigurationIcon = () => {
  return (
    ...
    >
      <g>
        <path
          d="M114.3,26.9c3.1-2.4,6.9-5.2,10.5-8.3c2.7-2.3,4.8-2.1,7.1,0.5c2.7,3,5.6,5.9,8.5,8.8c2,1.9,2.3,3.5,0.4,5.8
        ...
        />
        <path
          d="M75.7,49.1c7.6,0.3,14.7,1.4,20.3,7.3c2.9,3,4.3,6.4,4.4,10.6c0.1,4.4-0.1,9,1,13.2c0.9,3.3,3,6.5,5.4,9.1
