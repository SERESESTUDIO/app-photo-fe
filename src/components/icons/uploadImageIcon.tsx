export const UploadImageIcon = () => {
  return (
    ...
    >
      <g>
        <path
          d="M81.6,0c2.2,0.8,3.9,2.3,5.5,3.9c7.6,7.6,15.1,15.2,22.8,22.8c2,2,3.1,4.3,2.6,7.2c-0.6,2.9-2.3,4.9-5.1,5.8
        ...
        />
        <path
          d="M27.5,65c0,26.8,0,53.3,0,79.9c35,0,69.8,0,104.8,0c0-26.6,0-53.1,0-79.9c-0.5,0-1.1,0-1.6,0c-6.9,0-13.9,0-20.8,0
